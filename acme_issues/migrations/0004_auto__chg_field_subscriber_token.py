...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'acme_issues_subscriber', 'token', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Subscriber.token'
        db.alter_column(u'acme_issues_subscriber', 'token', self.gf('django.db.models.fields.CharField')(default='', max_length=32, unique=True))
    ...
    models = {
        ...
        u'acme_issues.subscriber': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'max_length': '32', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        }
    }
