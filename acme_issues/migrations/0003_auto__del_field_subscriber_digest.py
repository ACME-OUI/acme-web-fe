...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Subscriber.digest'
        db.delete_column(u'acme_issues_subscriber', 'digest')


    def backwards(self, orm):
        # Adding field 'Subscriber.digest'
        db.add_column(u'acme_issues_subscriber', 'digest',
