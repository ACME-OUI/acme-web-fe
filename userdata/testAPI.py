...
velo_api.upload_file("/home/baldwin32/projects/acme-web-fe/acme_site/velo", "testAPI.py") #specify location of file and name of file
velo_api.create_instance() # creates a tool instance for ACME fake job
velo_api.create_remotelink()
jobconfig = velo_api.launch_job("acmetest") # launch the fake job, provide username for the acmetest server
