...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CategoryQuestion.source'
        db.add_column(u'issues_categoryquestion', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.IssueSource'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CategoryQuestion.source'
        db.delete_column(u'issues_categoryquestion', 'source_id')
    ...
    models = {
        ...
        u'issues.categoryquestion': {
            ...
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['issues.IssueSource']", 'null': 'True', 'blank': 'True'}),
