...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'acme_issues_subscriber', 'token', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Subscriber.token'
        db.alter_column(u'acme_issues_subscriber', 'token', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32, null=True))
